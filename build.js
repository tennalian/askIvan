...
/***/ function(module, exports, __webpack_require__) {
	...
	var _faq = __webpack_require__(159);
	...
	var faq = ['И?', 'А если подумать?', 'Хммм..', 'Ты уверена?', 'А потом?', 'Так, а суть вопроса в чем?', 'Подумай хорошо!'];

	_reactDom2.default.render(_react2.default.createElement(_faq2.default, { data: faq }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = _react2.default.createClass({
		...
		randomAnswer: function randomAnswer(min, max) {
			...
			if (this.state.questionArr == null) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'photo' },
						_react2.default.createElement('img', { src: 'https://i06.fotocdn.net/s6/240/user_s/440/2438576111.jpg' })
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'p',
							null,
							'Ну давай же сюда свой вопрос!'
						)
					),
					_react2.default.createElement(
						'div',
						{ className: 'chat__textarea' },
						_react2.default.createElement('textarea', { className: 'form-control', defaultValue: '', placeholder: 'Место для глупого вопроса', ref: 'text', rows: '10' }),
						_react2.default.createElement(
							'button',
							{ type: 'submit', className: 'btn btn-success pull-right', onClick: this.question },
							'Задать вопрос'
						),
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'answer' },
							_react2.default.createElement('img', { src: 'http://www.uproducers.com/wp-content/themes/upi_website/images/load-am.gif' })
						)
					)
				);
			} else {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'photo' },
						_react2.default.createElement('img', { src: 'https://media.licdn.com/mpr/mpr/shrinknp_400_400/p/5/005/0b2/356/0d546b4.jpg' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'chat__window' },
